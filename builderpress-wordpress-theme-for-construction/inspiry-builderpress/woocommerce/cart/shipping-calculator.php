...
<form class="woocommerce-shipping-calculator bp-shipping-calculator"
	...
	<section class="shipping-calculator-form" style="display:block !important;">
		...
		<p class="form-row form-row-wide" id="calc_shipping_country_field">
			<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state"
				...
				<option value=""><?php esc_html_e( 'Select a country&hellip;', 'inspiry-builderpress' ); ?></option>
				<?php
		...
		<p class="form-row form-row-wide" id="calc_shipping_state_field">
			...
			if ( is_array( $states ) && empty( $states ) ) {
				...
				?><input type="hidden" name="calc_shipping_state" id="calc_shipping_state"
				         placeholder="<?php esc_attr_e( 'State / county', 'inspiry-builderpress' ); ?>" /><?php
				...
				<select name="calc_shipping_state" id="calc_shipping_state"
				        placeholder="<?php esc_attr_e( 'State / county', 'inspiry-builderpress' ); ?>">
					<option value=""><?php esc_html_e( 'Select a state&hellip;', 'inspiry-builderpress' ); ?></option>
					<?php
		...
		if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', false ) ) :
			...
			<p class="form-row form-row-wide" id="calc_shipping_city_field">
				<input type="text" class="input-text"
				       ...
				       placeholder="<?php esc_attr_e( 'City', 'inspiry-builderpress' ); ?>" name="calc_shipping_city"
		...
		if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_postcode_field">
				<input type="text" class="input-text"
				       ...
				       placeholder="<?php esc_attr_e( 'Postcode / ZIP', 'inspiry-builderpress' ); ?>"
		...
		<p class="clearfix">
			<button type="submit" name="calc_shipping" value="1"
			        class="button"><?php esc_html_e( 'Update Totals', 'inspiry-builderpress' ); ?></button>
		</p>
